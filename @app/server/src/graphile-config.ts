...
import PrimaryKeyMutationsOnlyPlugin from "./plugins/PrimaryKeyMutationsOnlyPlugin.js";
import RemoveQueryQueryPlugin from "./plugins/RemoveQueryQueryPlugin.js";
import SubscriptionsPlugin from "./plugins/SubscriptionsPlugin.js";
...
export function getPostGraphileOptions({
  ...
  const options: PostGraphileOptions<Request, Response> = {
    ...
    appendPlugins: [
      ...
      PgSimplifyInflectorPlugin as any,
