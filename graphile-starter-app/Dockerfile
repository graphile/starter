...
# push them to a .envvar file that we can source from ENTRYPOINT.
RUN echo "export PORT=\"$PORT\" NODE_ENV=\"$NODE_ENV\" ROOT_DOMAIN=\"$ROOT_DOMAIN\" ROOT_URL=\"$ROOT_URL\" TARGET=\"TARGET\"" >> /app/.envvar && chmod +x /app/.envvar
